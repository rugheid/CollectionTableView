...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/CollectionTableView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rugen Heidbuchel' => 'rugen.heidbuchel@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/CollectionTableView.git', :tag => s.version.to_s }
